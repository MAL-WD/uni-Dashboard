...
export const links = [
  {
    ...
    links: [
      {
        name: 'Dashboard',
        icon: <img src={dashboard} className="w-6 h-6 text-gray-400" />,
      },
      {
        name: 'Courses',
        icon: <img src={course} className="w-6 h-6 text-gray-400" />,
      },
      {
        name: 'Blogs',
        icon: <img src={article} className="w-6 h-6 text-gray-400" />,
      },
      {
        name: 'Chat',
        icon: <img src={chat} className="w-6 h-6" />,
